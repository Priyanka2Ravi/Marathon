...
public class EditIndividuals {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("username")).sendKeys("priya13ravi@testleaf.com");
		driver.findElement(By.id("password")).sendKeys("Paramesh2710**");
		...
		Thread.sleep(2000);
		String firstname = driver.findElement(By.xpath("//span[contains(@class,'toastMessage')]")).getText();
		// Verify the first name as 'Ganesh'
		System.out.println(firstname);
		if(firstname.contains("Ganesh"))
		{
